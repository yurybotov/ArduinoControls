/*
	Обработчик двухточечного энкодера вращения

	Подключается к двум цифровым входам: clk и data

	При изменении сотояния генерирует события:
  * onChange

  Есть настройка верхней и нижней границы, начального значения, ражим работы циклический или с упорами 
